...
export const Island = React.forwardRef<HTMLDivElement, IslandProps>(
  (
    ...
    >
      <span
        className="Island__crosshair Island__crosshair--tl"
        aria-hidden="true"
      />
      <span
        className="Island__crosshair Island__crosshair--tr"
        aria-hidden="true"
      />
      <span
        className="Island__crosshair Island__crosshair--bl"
        aria-hidden="true"
      />
      <span
        className="Island__crosshair Island__crosshair--br"
        aria-hidden="true"
      />
      {children}
    </div>
