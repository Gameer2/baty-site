...
export const STEFFENSEN_PORT_SPEC: PortSpec = {
  engineId: "numerical",
  methodId: "steffensen",
  inputs: [
  ...
  executionMode: "live",
  pagePath: "/math-lab/engines/numerical/methods/steffensen.html",
  pageStoreKey: "engine-lab:numerical-steffensen",
  compute: (inputs): ComputeResult => {
    ...
    try {
      const iterations = Algorithms.runSteffensen(
        compiled.fn,
        x0,
        tol,
        maxIter,
