...
export const BROYDENS_METHOD_PORT_SPEC: PortSpec = {
  engineId: "numerical",
  methodId: "broydens-method",
  inputs: [
    {
      key: "system",
  ...
  executionMode: "live",
  pagePath: "/math-lab/engines/numerical/methods/broydens-method.html",
  pageStoreKey: "engine-lab:numerical-broydens-method",
  compute: (inputs): ComputeResult => {
    ...
    try {
      const iterations = Algorithms.runBroyden(F, x0, tol, maxIter);
