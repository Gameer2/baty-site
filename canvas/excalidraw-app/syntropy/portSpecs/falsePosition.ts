...
export const FALSE_POSITION_PORT_SPEC: PortSpec = {
  engineId: "numerical",
  ...
  executionMode: "live",
  pagePath: "/math-lab/engines/numerical/methods/false-position.html",
  pageStoreKey: "engine-lab:numerical-false-position",
  compute: (inputs): ComputeResult => {
    ...
    try {
      const iterations = Algorithms.runFalsePosition(
        compiled.fn,
        a,
        b,
        tol,
