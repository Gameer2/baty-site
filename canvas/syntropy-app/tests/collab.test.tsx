...
describe("collaboration", () => {
  ...
  // Syntropy Canvas: collaboration is unconditionally disabled for v0 (no
  // server configured — see App.tsx's isCollabDisabled and
  // docs/superpowers/specs/2026-08-04-math-canvas-design.md), so the
  // window.collab.startCollaboration hook this test relies on is never
  // attached. Skipped rather than worked around, since the feature it
  // exercises is intentionally off, not broken.
