(function () {
  ...
  const form = document.getElementById("newtonDDForm");
  ...
  const STORE_KEY = "engine-lab:numerical-newton-dd";
  ...
  function render(result) {
    ...
    Engine.renderKatex(formulaBlock, "P(x) = f[x_0] + \\sum_{k=1}^{n} f[x_0,\\dots,x_k] \\prod_{j=0}^{k-1}(x - x_j)", true);
